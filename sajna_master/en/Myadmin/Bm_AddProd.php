...
require_once('../lib/dbconnect.php');
	...
	if(isset($_POST['Submit'])){
		...
		$price = $_POST['Price'];
		$in = "INSERT INTO bm_products(Name,Description,Description1,Price,bmCatId)VALUES('$name','$desc','$description','$price',$cid)";
...
<form name="AddProductForm" method="post" action="" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <tr>
    <td>Description</td>
    <td><textarea name="desc1" rows="3" cols="23"></textarea></td>
  </tr>
  <tr>
    <td>Price</td>
