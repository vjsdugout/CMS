...
color:#FFFFFF;
    ...
    <table width="100%" height="288" border="0" align="center" cellpadding="0" cellspacing="3" id="feedbacktable">
      <tbody>
        ...
        <tr>
          <td width="30%" align="right"><span>Votre Nom :</span></td>
          <td width="70%"><input name="name" id="name" type="text"  class="feedbackinput"/></td>
        </tr>
        <tr>
          <td align="right"><span>Votre Courrier :</span></td>
          <td><input name="email" id="email" type="text" class="feedbackinput"/></td>
        </tr>
        <tr>
          <td align="right"><span>Votre Contact non . :</span></td>
          <td><input name="contact" id="contact" type="text" class="feedbackinput" /></td>
        </tr>
        <tr>
          <td align="right"><span>Votre Adresse :</span></td>
          <td><input name="address" id="address" type="text" class="feedbackinput" /></td>
        </tr>
        <tr>
          <td align="right"><span>Votre Ville :</span></td>
          <td><input name="city" id="city" type="text" class="feedbackinput" />            </td>
        </tr>

        <tr>
          <td height="101" valign="top"><span style="margin-left:128px;">Commentaires:</span></td>
          <td valign="top"><textarea name="desc" id="desc" rows="6" style="width:180px;"></textarea></td>
          </tr>
        <tr>
          <td height="24"></td>
          <td><input type="submit" name="submit" value="Soumettre" /><input type="reset" name="reset" value="Clear" /></td>
        </tr>
