...
<body>
	...
	<div id="lft_nav">
		...
		<td><input type="radio" name="r1" value="Yes"/>Yes
   ...
   <tr>
   <td colspan="6" align="center"><input type="submit" name="submit" value="Reservation"/><input type="reset" name="reset" value="Reset"/></td>
   </tr>
		</form>
		</table></div>
